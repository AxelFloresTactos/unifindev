...
<script type="text/javascript">
    ...
    window.onload = function() {
        ...
        vaadin.initApplication("negociador", {
            "browserDetailsUrl": "<?php echo $UNI2_URL; ?>historialCotizador/",
            "serviceUrl": "<?php echo $UNI2_URL; ?>historialCotizador/",
        ...
        var text = '{"userName": "<?=$user?>", "nombreCliente": "<?=$name?>", "uuidCliente": "<?=$AccountId?>"}';
        console.log(text);
