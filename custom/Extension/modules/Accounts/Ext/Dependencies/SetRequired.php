<?php
    ...
    $dependencies['Accounts']['SectorEconomico_required'] = array(
            'hooks' => array('all'),
            'trigger' => 'true',
            'triggerFields' => array('tipodepersona_c','tipo_registro_c','sectoreconomico_c'),
            'onload' => true,
            'actions' => array(
                    array(
                            'name' => 'SetRequired',
...
/** Carlos Zaragoza: Al cambiar tipo de registro a cliente bloquear estatus seleccionando integración de expediente*/
/*
